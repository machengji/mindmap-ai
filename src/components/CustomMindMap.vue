      ...
      <g :transform="`translate(${view.x}, ${view.y}) scale(${view.scale})`" :filter="isHandDrawn ? 'url(#handDrawnFilter)' : ''">
        ...
        >
          ...
          <rect 
            ...
            :width="node.width" 
            :height="node.height" 
            :rx="skeletonStyle === 'straight' ? '4' : '20'"
            :style="{ 
    ...
    <div class="absolute top-6 right-6 flex flex-col gap-2 z-50">
      <div class="bg-white/95 backdrop-blur-md p-2 rounded-2xl shadow-2xl border border-slate-200 flex flex-col gap-3">
          ...
          <div class="flex gap-1.5">
            <button 
              ...
              :class="[
                ...
                currentTheme === key ? 'border-indigo-500 scale-110' : 'border-transparent hover:scale-105'
              ]"
          ...
          <div class="flex bg-slate-100/50 rounded-xl p-1 gap-1">
            <button 
              ...
              :class="[
                ...
                skeletonStyle === s ? 'bg-white shadow-md text-indigo-600' : 'text-slate-500 hover:text-slate-700'
              ]"
            >
        ...
        >
          ...
          <div :class="['w-9 h-5 rounded-full relative transition-all', isHandDrawn ? 'bg-indigo-600' : 'bg-slate-200']">
            <div :class="['absolute top-1 w-3 h-3 bg-white rounded-full transition-all', isHandDrawn ? 'left-[20px]' : 'left-1']" />
          </div>
        </button>
      </div>
    </div>
    ...
    >
      ...
      <div class="flex items-center gap-3">
        ...
        <button 
          ...
          class="bg-white/10 text-white/70 p-2.5 rounded-2xl hover:bg-red-500 hover:text-white transition-all"
        >
          <Trash2 :size="18" />
        </button>
      </div>
